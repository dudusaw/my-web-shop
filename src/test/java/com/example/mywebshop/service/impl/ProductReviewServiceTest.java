...
public class ProductReviewServiceTest {
    ...
    @Test
    public void testGetReviewById3() {
        // Arrange
        User user = new User();
        user.setEmail("jane.doe@example.org");
        user.setPassword("iloveyou");
    ...
    @Test
    public void testGetReviewById4() {
        // Arrange
        User user = new User();
        user.setEmail("jane.doe@example.org");
        user.setPassword("iloveyou");
    ...
    @Test
    public void testCheckAndSubmitReview3() {
        // Arrange
        User user = new User();
        user.setEmail("jane.doe@example.org");
        user.setPassword("iloveyou");
    ...
    @Test
    public void testCheckAndSubmitReview4() {
        // Arrange
        User user = new User();
        user.setEmail("jane.doe@example.org");
        user.setPassword("iloveyou");
    ...
    @Test
    public void testSubmitReviewVote4() {
        // Arrange
        User user = new User();
        user.setEmail("jane.doe@example.org");
        user.setPassword("iloveyou");
    ...
    @Test
    public void testSubmitReviewVote5() {
        // Arrange
        User user = new User();
        user.setEmail("jane.doe@example.org");
        user.setPassword("iloveyou");
    ...
    @Test
    public void testSubmitReviewVote6() {
        // Arrange
        User user = new User();
        user.setEmail("jane.doe@example.org");
        user.setPassword("iloveyou");
